...
class UserEntityData extends DataClass implements Insertable<UserEntityData> {
  final int id;
  final String name;
  const UserEntityData({required this.id, required this.name});
  @override
  ...
  UserEntityData copyWith({int? id, String? name}) => UserEntityData(
        id: id ?? this.id,
        name: name ?? this.name,
      );
  @override
...
class UserEntityCompanion extends UpdateCompanion<UserEntityData> {
  ...
  UserEntityCompanion copyWith({Value<int>? id, Value<String>? name}) {
    return UserEntityCompanion(
      id: id ?? this.id,
      name: name ?? this.name,
    );
